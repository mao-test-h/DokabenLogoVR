...
namespace MainContents.RotateTest
{
    ...
    public sealed class RotateTestJobSystem : JobComponentSystem
    {
        /// <summary>
        /// 定数
        /// </summary>
        ...
        /// </summary>
        [BurstCompile]
        struct RotateJob : IJobProcessComponentData<Position, Rotation, DokabenRotationData>
        {
            /// <summary>
            /// カメラの位置情報
            /// </summary>
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            this._rotateJob.CameraPosition = this._sharedCameraDataGroup.CameraPosition[0].Value;
            this._rotateJob.DeltaTime = Time.deltaTime;
